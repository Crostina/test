...
<?php
include '../../../Controller/CoachC.php';; // Assurez-vous que le chemin est correct

$c = new CoachC();
$tab = $c->listCoaches(); // Utilisez la méthode listProduits
...
<table border="1" align="center" width="60%">
    ...
    ?>
        <tr>
            ...
            <td><?= $coach['diplome']; ?></td>
            <td><?= $coach['motdepasse']; ?></td>
            <td>
                <a href="updateCoach.php?id=<?php echo $coach['id']; ?>">Update</a>
            </td>
            <td>
                <a href="deleteCoach.php?id=<?php echo $coach['id']; ?>">Delete</a>
            </td>
